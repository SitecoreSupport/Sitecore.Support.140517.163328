namespace Sitecore.Support.Security.Authentication
{
  ...
  public class BasicHttpAuthenticationProvider : Sitecore.Security.Authentication.BasicHttpAuthenticationProvider
  {
    public override void WriteAuthenticationResponse(HttpRequest request, HttpResponse response)
    {
      ...
      response.AppendHeader("WWW-Authenticate", "BASIC Realm=" + base.Realm);
